...
const splashPlaceholderName = 'iranlegal_splash_placeholder';
...
`;
  ...
  for (const oldPath of [
    path.join(javaRoot, 'com', 'iranlegal', 'app', 'MainActivity.java'),
...
function configureManifest() {
  ...
  const activityMatch = activityTags.find((match) =>
    /android:name="(?:\.MainActivity|com\.iranlegal\.tools\.MainActivity)"/.test(match[0]),
  );
