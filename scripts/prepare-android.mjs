...
for (const required of [
  ...
  'android-branding/mipmap-mdpi/iranlegal_launcher.png',
  'android-branding/mipmap-xxxhdpi/iranlegal_launcher.png',
  'android-branding/drawable-nodpi/iranlegal_splash_logo.png',
]) {
